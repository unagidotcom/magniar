...
export default function HandledClients() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#070707] py-24 border-t border-white/5" id="handled-clients">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="mb-10 flex flex-wrap items-center justify-between gap-4 border-b border-white/5 pb-6">
          ...
          <div className="rounded-full bg-white/5 border border-white/10 px-4 py-1.5 font-mono text-[10px] text-gray-400">
            ...
            {filteredClients.map((client, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-white/5 bg-brand-dark/40 p-6 backdrop-blur-md transition-all duration-300 hover:border-brand-blue/30 hover:scale-[1.01]"
                >
                  <div>
                    {/* Header meta */}
                    <div className="flex items-center justify-between border-b border-white/5 pb-3.5 mb-4">
                      ...
                      <div className="rounded-full bg-brand-blue/10 border border-brand-blue/20 px-2.5 py-0.5 font-mono text-[9px] font-bold text-brand-blue uppercase">
                        {isEcom ? "STOREFRONT" : "ADS NODE"}
                      </div>
                    </div>

                    {/* Client Name & Service type */}
                    <h3 className="font-display text-xl font-bold tracking-tight text-white group-hover:text-brand-blue transition-colors">
                      {client.name}
                    </h3>
                    ...
                    <div className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-white/5 px-2.5 py-1 font-mono text-xs text-gray-300">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-12 rounded-2xl border border-white/5 bg-white/[0.01] p-6 backdrop-blur-md md:p-8 flex flex-col sm:flex-row items-center justify-between gap-6"
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-display text-base font-semibold text-white">Full-Funnel Client Infrastructure</h4>
          ...
          <a
            href="#inquire"
            className="group flex items-center gap-1.5 rounded-full bg-white/5 hover:bg-white/10 px-5 py-2 text-xs font-semibold uppercase tracking-wider text-gray-300 hover:text-white transition-all cursor-pointer whitespace-nowrap"
          >
