      ...
      <div className="space-y-8 bg-[#080A0D] border border-white/10 p-6 sm:p-8 rounded-xl shadow-xl">
        ...
        <div className="space-y-2.5">
          ...
          <textarea
            ...
            className="w-full p-4 bg-[#050505] border border-white/15 rounded-lg font-sans text-base text-white placeholder-slate-500 focus:outline-none focus:border-[#0099FF] focus:ring-1 focus:ring-[#0099FF] transition-all leading-relaxed"
          />
        </div>
        ...
        <div className="space-y-3">
          ...
          {formData.attachmentName ? (
            <div className="p-5 rounded-lg bg-[#050505] border border-[#0099FF]/50 flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                <FileUp className="w-6 h-6 text-[#0099FF]" />
                <div>
                  <p className="font-sans text-sm font-bold text-white">
                    {formData.attachmentName}
                  </p>
                  <p className="font-sans text-xs text-[#0099FF]">
            ...
            >
              <FileUp className="w-8 h-8 text-[#0099FF] mx-auto mb-3" />
