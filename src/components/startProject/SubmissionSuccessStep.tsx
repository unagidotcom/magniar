  ...
  return (
    <div className="space-y-10 animate-fadeIn max-w-3xl mx-auto py-6">
      ...
      <div className="text-center space-y-4">
        <div className="w-16 h-16 rounded-full bg-[#0099FF]/10 border border-[#0099FF] flex items-center justify-center mx-auto shadow-[0_0_30px_rgba(0,153,255,0.3)]">
          <CheckCircle2 className="w-8 h-8 text-[#0099FF]" />
        </div>

        <div className="space-y-2">
          <span className="font-sans text-xs font-semibold text-[#0099FF] tracking-wider uppercase">
      ...
      <div className="bg-[#080A0D] border border-white/10 p-6 rounded-xl flex flex-wrap items-center justify-between gap-4 shadow-xl">
        <div className="space-y-1">
          ...
          <span className="font-mono text-2xl font-bold text-[#0099FF] tracking-widest">
            {requestId}
          </span>
        ...
        >
          {copied ? (
            ...
            <>
              <Copy className="w-4 h-4 text-[#0099FF]" />
      ...
      <div className="bg-[#080A0D] border border-white/10 p-6 sm:p-8 rounded-xl space-y-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 font-sans text-sm">
          ...
          <div className="p-5 rounded-lg bg-[#050505] border border-white/10 space-y-1.5">
            <span className="text-[#0099FF] font-bold text-xs block">Step 01 / Strategic Review</span>
          ...
          {/* 02 */}
          <div className="p-5 rounded-lg bg-[#050505] border border-white/10 space-y-1.5">
            <span className="text-[#0099FF] font-bold text-xs block">Step 02 / Direct Contact</span>
          ...
          {/* 03 */}
          <div className="p-5 rounded-lg bg-[#050505] border border-white/10 space-y-1.5">
            <span className="text-[#0099FF] font-bold text-xs block">Step 03 / Discovery Session</span>
          ...
          {/* 04 */}
          <div className="p-5 rounded-lg bg-[#050505] border border-white/10 space-y-1.5">
            <span className="text-[#0099FF] font-bold text-xs block">Step 04 / Tailored Proposal</span>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 border-t border-white/10">
        <button
          ...
          className="w-full sm:w-auto px-8 py-4 rounded-lg bg-[#0099FF] hover:bg-[#0088EE] text-white font-sans text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_20px_rgba(0,153,255,0.35)]"
        >
