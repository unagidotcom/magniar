    ...
    <section className="py-20 sm:py-28 border-b border-white/10 bg-[#080B10] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-8 bg-[#050505] border border-white/15 relative space-y-6 hover:border-[#0099FF]/50 transition-colors">
            <div className="flex items-center justify-between pb-4 border-b border-white/10 font-mono text-xs">
              <span className="text-[#0099FF] font-bold flex items-center gap-2">
                <Megaphone className="w-4 h-4 text-[#0099FF]" />
                SIDE A / PERFORMANCE
              </span>
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-white uppercase font-mono leading-tight">
                ...
                <span className="text-[#0099FF]">THE TECHNICAL BLIND SPOT.</span>
              </h3>
            ...
            <div className="space-y-2 font-mono text-xs text-[#F5F7FA]">
              ...
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                ...
                <span className="text-[#0099FF] font-bold">100% CAPI MATCH</span>
              </div>
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                <span>02 / DYNAMIC SUB-1 SECOND LANDING PAGES</span>
                <span className="text-[#0099FF] font-bold">&lt;800ms LOAD</span>
              </div>
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                <span>03 / PRODUCT FEED SYNCHRONIZATION</span>
                <span className="text-[#0099FF] font-bold">REAL-TIME STOCK</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 bg-[#050505] border border-white/15 relative space-y-6 hover:border-[#0099FF]/50 transition-colors">
            <div className="flex items-center justify-between pb-4 border-b border-white/10 font-mono text-xs">
              <span className="text-[#0099FF] font-bold flex items-center gap-2">
                <Code2 className="w-4 h-4 text-[#0099FF]" />
                SIDE B / ENGINEERING
              </span>
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-white uppercase font-mono leading-tight">
                ...
                <span className="text-[#0099FF]">THE GROWTH BLIND SPOT.</span>
              </h3>
              <p className="text-sm text-[#8D949E] leading-relaxed">
            ...
            <div className="space-y-2 font-mono text-xs text-[#F5F7FA]">
              ...
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                ...
                <span className="text-[#0099FF] font-bold">+18% CONVERSION</span>
              </div>
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                <span>02 / MULTI-TOUCH ATTRIBUTION DATA LAYER</span>
                <span className="text-[#0099FF] font-bold">FIRST-PARTY</span>
              </div>
              <div className="p-2.5 bg-[#0A0D12] border border-white/10 flex items-center justify-between">
                <span>03 / BEHAVIORAL FUNNEL AUTOMATION</span>
                <span className="text-[#0099FF] font-bold">TRIGGERS</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Banner */}
        <div className="mt-8 p-6 bg-[#0099FF]/10 border border-[#0099FF]/30 flex items-center gap-4 font-mono text-xs text-[#F5F7FA]">
          <Zap className="w-5 h-5 text-[#0099FF] shrink-0" />
          <span>
