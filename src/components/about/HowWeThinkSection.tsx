      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#F5F7FA] uppercase leading-tight">
            ...
            <span className="text-[#0099FF]">FOR HIGH-STAKES GROWTH</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {THINKING_PRINCIPLES.map((principle) => (
            <div
              ...
              className="p-6 bg-[#0A0D12] border border-white/10 hover:border-[#0099FF]/50 transition-colors group flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between font-mono text-xs">
                  <span className="text-[#0099FF] font-bold">{principle.number} / PRINCIPLE</span>
                  <Compass className="w-4 h-4 text-white/20 group-hover:text-[#0099FF] transition-colors" />
                </div>
                <h3 className="text-lg font-bold text-white uppercase group-hover:text-[#0099FF] transition-colors">
                  {principle.title}
                </h3>
                <p className="text-xs font-mono text-[#0099FF] uppercase tracking-wider">
                  {principle.subtitle}
                </p>
        ...
        <div className="p-8 sm:p-12 bg-gradient-to-br from-[#0A0D12] to-[#050505] border border-white/15 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
            <Target className="w-64 h-64 text-[#0099FF]" />
          </div>
          ...
          <div className="max-w-4xl space-y-6 relative z-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-white/10 font-mono text-xs">
              <div className="p-3 bg-[#050505] border border-white/10">
                <span className="text-[#0099FF] font-bold block mb-0.5">01 DIAGNOSE</span>
                <span className="text-[#8D949E]">Margins & Supply</span>
              </div>
              <div className="p-3 bg-[#050505] border border-white/10">
                <span className="text-[#0099FF] font-bold block mb-0.5">02 SELECT</span>
                <span className="text-[#8D949E]">Channels & Tech</span>
              </div>
              <div className="p-3 bg-[#050505] border border-white/10">
                <span className="text-[#0099FF] font-bold block mb-0.5">03 ENGINEER</span>
                <span className="text-[#8D949E]">System & Funnel</span>
              </div>
              <div className="p-3 bg-[#050505] border border-white/10">
                <span className="text-[#0099FF] font-bold block mb-0.5">04 SCALE</span>
