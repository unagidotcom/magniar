    ...
    <section className="py-20 sm:py-28 border-b border-white/10 bg-[#050505] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16">
          <div>
            ...
            <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#F5F7FA] uppercase">
              THE CONNECTED <br />
              <span className="text-[#0099FF]">GROWTH ARCHITECTURE</span>
            </h2>
          </div>
            ...
            <div className="relative z-20 min-h-[440px] flex items-center justify-center">
              ...
              <div
                className={`px-8 py-6 rounded-[2px] bg-[#050505] border-2 transition-all text-center shadow-2xl relative ${
                  activeDiscipline
                    ? 'border-[#0099FF] shadow-[0_0_40px_rgba(0,153,255,0.25)]'
                    : 'border-white/20'
                }`}
              >
                <span className="font-mono text-[10px] text-[#0099FF] tracking-widest uppercase block mb-1">
                  CORE OUTCOME
                </span>
              ...
              <button
                ...
                className={`absolute top-0 left-1/2 -translate-x-1/2 px-6 py-4 border font-mono text-left transition-all z-30 cursor-pointer ${
                  activeDiscipline === 'performance'
                    ? 'bg-[#0099FF] border-white text-white shadow-[0_0_25px_rgba(0,153,255,0.4)] scale-105'
        ...
        <div className="md:hidden space-y-3 mb-8">
          <div className="text-center p-4 bg-[#080B10] border border-[#0099FF]/40 rounded-[2px]">
            <span className="text-xs font-mono text-[#0099FF] block">CENTRAL OUTCOME</span>
        ...
        <div className="p-6 sm:p-8 bg-[#080B10] border border-[#0099FF]/40 relative">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-white/10 pb-6 mb-6">
            <div className="space-y-1">
              <div className="flex items-center gap-3 font-mono text-xs">
                <span className="text-[#0099FF] font-bold">{selectedNode.numberLabel} / DISCIPLINE INSPECTOR</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-[#0099FF]">
