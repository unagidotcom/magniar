      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#F5F7FA] uppercase leading-tight">
            ...
            <span className="text-[#B89A72]">CHOOSE MAGNIAR.</span>
          </h2>
        ...
        <div className="space-y-4 mb-12">
          {MAGNIAR_DIFFERENTIATORS.map((diff) => (
            <div
              key={diff.number}
              className="p-6 bg-[#080B10] border border-white/10 hover:border-[#B89A72]/50 transition-all group grid grid-cols-1 md:grid-cols-12 gap-4 items-center"
            >
              <div className="md:col-span-1 font-mono text-xl font-bold text-[#B89A72]">
                {diff.number}
              </div>
              ...
              <div className="md:col-span-4 space-y-1">
                ...
                <span className="font-mono text-xs text-[#B89A72] block">
                  {diff.shortDesc}
                </span>
              </div>
        ...
        <div className="p-6 bg-[#0A0D12] border border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 font-mono text-xs">
          <div className="flex items-center gap-3">
            <ShieldCheck className="w-5 h-5 text-[#B89A72] shrink-0" />
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#B89A72] text-white font-bold uppercase tracking-wider hover:bg-[#8F714D] transition-all flex items-center gap-2 shrink-0 cursor-pointer"
          >
