...
export const TestimonialsSection: React.FC = () => {
  return (
    <section id="testimonials" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-12 bg-[#0B0D0F] text-[#F5F7FA] border-t border-white/10 relative">
      <div className="max-w-[1440px] mx-auto space-y-12">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h2 className="font-heading text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-[1.08]">
            Confidentiality and <span className="text-[#B89A72]">authenticity.</span>
          </h2>
        </div>

        {/* Clean Honest Placeholder Card (No Fake Testimonials) */}
        <div className="p-8 sm:p-12 bg-[#0B0D0F] border border-white/10 rounded-[2px] max-w-4xl space-y-6 relative overflow-hidden">
          <div className="flex items-center justify-between pb-4 border-b border-white/10 font-sans text-xs">
            <div className="flex items-center gap-2 text-[#B89A72] font-semibold">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base text-[#D9DEE5] leading-relaxed max-w-2xl font-sans font-normal">
          ...
          <div className="p-4 bg-[#0B0D0F] border border-white/10 rounded-[2px] flex items-center gap-3 font-sans text-xs text-[#D9DEE5]">
            <Lock className="w-4 h-4 text-[#B89A72] shrink-0" />
