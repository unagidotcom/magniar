  ...
  return (
    <section className="py-20 sm:py-28 bg-[#080B10] relative overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="p-8 sm:p-14 bg-[#050505] border-2 border-[#B89A72] relative overflow-hidden shadow-[0_0_50px_rgba(184,154,114,0.15)] text-center sm:text-left">
          <div className="max-w-4xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#B89A72]/10 text-[#B89A72] border border-[#B89A72]/30 font-mono text-xs font-bold uppercase tracking-wider">
