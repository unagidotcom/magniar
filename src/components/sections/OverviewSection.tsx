    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#0A0C0F] p-6 sm:p-10">
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#0099FF]/30 bg-[#0099FF]/10 px-3 py-1 text-xs font-mono text-[#0099FF]">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[#0099FF] px-4 py-2.5 text-xs font-medium text-black transition-all hover:bg-[#33AFFF]"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-xl border border-white/10 bg-[#0A0C0F] p-6 hover:border-[#0099FF]/30 transition-colors group">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-white/5 text-[#0099FF] border border-white/5 group-hover:scale-105 transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg bg-[#050505] border border-white/5 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono text-[11px] text-[#0099FF]">01 / PUBLIC WEBSITE</span>
            ...
            <div className="p-4 rounded-lg bg-[#050505] border border-white/5 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono text-[11px] text-[#0099FF]">02 / CLIENT PORTAL</span>
            ...
            <div className="p-4 rounded-lg bg-[#050505] border border-white/5 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-mono text-[11px] text-[#0099FF]">03 / ADMIN SYSTEM</span>
      ...
      <div className="rounded-xl border border-[#0099FF]/30 bg-[#0099FF]/5 p-6 font-mono text-xs text-[#8D949E] space-y-2">
