    ...
    <div className="space-y-8 animate-fadeIn">
        ...
        {MOTION_TOKENS.map((token: MotionToken) => (
          ...
          >
            <div className="flex items-center justify-between font-mono text-xs">
              <span className="text-[#B89A72] font-semibold">{token.token}</span>
            ...
            <div className="pt-2">
              <div className="p-4 rounded-lg bg-[#050505] border border-white/10 relative h-20 flex items-center overflow-hidden">
                <div
                  className={`h-10 px-4 rounded bg-[#B89A72] text-black font-mono text-xs font-semibold flex items-center gap-2 transition-all ${
              ...
              <button
                ...
                className="mt-3 w-full py-2 rounded-lg bg-white/5 border border-white/10 text-xs font-mono text-white hover:bg-[#B89A72]/20 hover:text-[#B89A72] hover:border-[#B89A72]/40 transition-all flex items-center justify-center gap-1.5"
              >
      ...
      <div className="rounded-xl border border-white/10 bg-[#0A0C0F] p-6 space-y-4">
        <div className="font-mono text-xs text-white font-medium flex items-center gap-2">
          <MousePointerClick className="h-4 w-4 text-[#B89A72]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-[#8D949E]">
          <div className="p-4 rounded-lg bg-[#050505] border border-white/5 space-y-2">
            <span className="font-mono text-[#B89A72]">01 / BUTTON HOVER STATES</span>
          ...
          <div className="p-4 rounded-lg bg-[#050505] border border-white/5 space-y-2">
            <span className="font-mono text-[#B89A72]">02 / CARD HOVER STATES</span>
            <p className="leading-relaxed">
              Border shifts from subtle white/0.08 to active blue rgba(184,154,114,0.4), subtle 2px vertical lift (-2px translateY), 0.15 opacity volumetric glow.
            </p>
          </div>
        </div>
      </div>
