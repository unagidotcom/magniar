  ...
  return (
    <div className="p-6 sm:p-8 bg-[#080B10] border border-white/10 space-y-6">
      <div className="pb-4 border-b border-white/10 space-y-1">
        <span className="font-mono text-xs text-[#B89A72] uppercase font-bold tracking-widest block">
          [ MEETING SUMMARY ]
        </span>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 pt-4 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-1">
            <label className="block font-mono text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
              <User className="w-3 h-3 text-[#B89A72]" />
              NAME
            </label>
            <input
              type="text"
              ...
              className="w-full px-3 py-2 bg-[#050505] border border-white/15 focus:border-[#B89A72] text-white text-xs font-sans focus:outline-none"
            />
          </div>

          <div className="space-y-1">
            <label className="block font-mono text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
              <Mail className="w-3 h-3 text-[#B89A72]" />
              EMAIL
            </label>
            <input
              type="email"
          ...
          <div className="space-y-1">
            <label className="block font-mono text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
              <Building2 className="w-3 h-3 text-[#B89A72]" />
              COMPANY
            </label>
            <input
              type="text"
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full py-4 bg-[#B89A72] text-white font-mono text-xs font-bold uppercase tracking-widest hover:bg-[#8F714D] disabled:opacity-40 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_20px_rgba(184,154,114,0.25)]"
          >
            {isConfirming ? (
