...
export const HeroDevControlPanel: React.FC<HeroDevControlPanelProps> = ({
  ...
  return (
    <div className={`p-4 sm:p-5 rounded-[2px] bg-[#0A0D12] border border-[#B89A72]/40 space-y-4 font-mono text-xs shadow-2xl ${className}`}>
      {/* Header Badge */}
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-white/10 pb-3">
        ...
        <span className="px-2 py-0.5 rounded bg-[#B89A72]/20 text-[#B89A72] text-[10px] font-semibold border border-[#B89A72]/40 uppercase">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-1">
        ...
        <div className="p-2.5 rounded bg-[#05070A] border border-white/10 space-y-1.5">
          ...
          <button
            ...
            className={`w-full py-1 text-[10px] rounded border font-semibold transition-colors cursor-pointer ${
              config.motionActive
                ? 'bg-[#B89A72]/20 border-[#B89A72] text-[#B89A72]'
        ...
        <div className="p-2.5 rounded bg-[#05070A] border border-white/10 space-y-1.5">
          <div className="text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
            <ShieldAlert className="w-3 h-3 text-[#B89A72]" />
        ...
        <div className="p-2.5 rounded bg-[#05070A] border border-white/10 space-y-1.5">
          <div className="text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
            <MousePointer className="w-3 h-3 text-[#B89A72]" />
        ...
        <div className="p-2.5 rounded bg-[#05070A] border border-white/10 space-y-1.5">
          <div className="text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
            <Layers className="w-3 h-3 text-[#B89A72]" />
        ...
        <div className="p-2.5 rounded bg-[#05070A] border border-white/10 space-y-1.5">
          <div className="text-[10px] text-[#8D949E] uppercase flex items-center gap-1">
            <Activity className="w-3 h-3 text-[#B89A72]" />
      ...
      <div className="pt-2 border-t border-white/10 space-y-2">
        <div className="flex items-center justify-between text-[11px] text-[#8D949E]">
          <span className="flex items-center gap-1.5 uppercase font-semibold text-[#F5F7FA]">
            <Eye className="w-3.5 h-3.5 text-[#B89A72]" />
            CHAPTER 04 REQUIRED VISUAL REVIEW PRESETS
          </span>
          <button
            onClick={onReset}
            className="text-[10px] text-[#B89A72] hover:underline flex items-center gap-1 cursor-pointer"
          >
